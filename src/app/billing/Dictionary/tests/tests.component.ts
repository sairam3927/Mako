...
export class TestsComponent implements OnInit {
  ...
  ngOnInit() {
    this.List = [
      ...
      {id: "7" , TestName:"THIAMINE (VITAMIN B1)",Description: "It may be necessary to test the other parent or the fetus / newborn.",Gene:"LCT",Genotype:"A/A",Comment:"This genotype is normal.",Recommendation:"It may be necessary to test the other parent or the fetus / newborn." }
    ];
  }

...
export class HaplotypesComponent implements OnInit {
  ...
  ngOnInit() {
    this.List = [
      ...
      {id: "7" , RowReference:"rs17033,rs13123099,rs1230025,", Haplotype:"SIRT1", condition:"2", Comment:"The result of this interaction recommends limiting alcohol consumption to a maximum of 5 g alcohol/day.", Recommendation:"Limit alcohol consumption to a maximum of 5 g/day (total alcohol 100%)."}
    ];
  }

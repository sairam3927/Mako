...
export class Data implements InMemoryDbService {
    createDb() {
        ...
        const Users = [
            { intApplicantId: 1, vcName: 'Dwayne', vcEmail: "Dwayne@gmail.com", status: true, vcPhone: '6045555555', vcPosition: "Project Managers ", vcSkills: ".Net", vcExperience: '3.5', vcCategory: 'IT', assign:3, vcJobType: "Permanant", vcResumePath: "", dtUpdated: null, intIQ: 100, vcReferral: "Yes", vcHRRecruiter: "Syeda", vcProcess: "4/15", workHours: 8.00, Permissions: '12/15',type:'Auditor' },
            { intApplicantId: 2, vcName: 'Dave', vcEmail: "Dave@gmail.com", status: true, vcPhone: '8043336666', vcPosition: "Project Managers ", vcSkills: "PHP", vcExperience: '2.5', vcCategory: 'IT', assign:7, vcJobType: "Contract", vcResumePath: "", dtUpdated: null, intIQ: 110, vcReferral: "No", vcHRRecruiter: "Siva", vcProcess: "8/15", workHours: 10.00, Permissions: '15/15', type:'Auditor' },
            { intApplicantId: 3, vcName: 'Emily', vcEmail: "Emily@gmail.com", status: true, vcPhone: '5041118888', vcPosition: "Production Team", vcSkills: "Java", vcExperience: '3.1', vcCategory: 'IT', assign:1, vcJobType: "Permanant", vcResumePath: "", dtUpdated: null, intIQ: 108, vcReferral: "Yes", vcHRRecruiter: "Syeda", vcProcess: "2/15", workHours: 8.00, Permissions: '12/15',type:'Auditee' },
            { intApplicantId: 4, vcName: 'Joe', vcEmail: 'Joe@gmail.com', status: true, assign:5, vcPhone: '7047775555', workHours: 8.00, Permissions: '12/15',type:'Auditor' },
            { intApplicantId: 5, vcName: 'Kate', vcEmail: 'Kate@gmail.com', status: true, assign:8, vcPhone: '9045559999', workHours: 8.00, Permissions: '12/15',type:'Auditor' },
            { intApplicantId: 6, vcName: 'Scott', vcEmail: 'Scott@gmail.com', status: true, assign:1, vcPhone: '9049995555', workHours: 8.00, Permissions: '12/15',type:'Auditee' },
            { intApplicantId: 7, vcName: 'Dan', vcEmail: 'Dan@gmail.com', status: true, assign:6, vcPhone: '5045559654', workHours: 8.00, Permissions: '12/15',type:'Auditor' },
            { intApplicantId: 8, vcName: 'Stephanie', vcEmail: 'Stephanie@gmail.com', assign:10, status: true, vcPhone: '6041231122', workHours: 8.00, Permissions: '12/15',type:'Auditee' },
        ];
